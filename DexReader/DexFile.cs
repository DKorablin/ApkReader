...
namespace AlphaOmega.Debug
{
	...
	public class DexFile : IDisposable
	{
		...
		private readonly Dex.header_item _header;
		private Dex.map_item[] _map_list;
		...
		public Dex.header_item header { get { return this._header; } }
		...
		public BaseTable<Data.Tables.string_data_row> STRING_DATA_ITEM
		{
			get { return new BaseTable<Data.Tables.string_data_row>(this, TableType.STRING_DATA_ITEM); }
		}

		/// <summary>Source bytecode payload</summary>
		public BaseTable<Data.Tables.code_row> CODE_ITEM
		{
			get { return new BaseTable<Data.Tables.code_row>(this, TableType.CODE_ITEM); }
		}
		...
		public BaseTable<Data.Tables.type_id_row> TYPE_ID_ITEM
		{
			get { return new BaseTable<Data.Tables.type_id_row>(this, TableType.TYPE_ID_ITEM); }
		}

		/// <summary>Referenced from <see cref="Data.Tables.class_def_row"/> and <see cref="Data.Tables.proto_id_row"/></summary>
		public BaseTable<Data.Tables.type_list_row> TYPE_LIST
		{
			get { return new BaseTable<Data.Tables.type_list_row>(this, TableType.TYPE_LIST); }
		}
		...
		/// </remarks>
		public BaseTable<Data.Tables.proto_id_row> PROTO_ID_ITEM
		{
			get { return new BaseTable<Data.Tables.proto_id_row>(this, TableType.PROTO_ID_ITEM); }
		}
		...
		/// The list must not contain any duplicate entries.
		/// </remarks>
		public BaseTable<Data.Tables.field_id_row> FIELD_ID_ITEM
		{
			get { return new BaseTable<Data.Tables.field_id_row>(this, TableType.FIELD_ID_ITEM); }
		}
		...
		/// The list must not contain any duplicate entries.
		/// </remarks>
		public BaseTable<Data.Tables.method_id_row> METHOD_ID_ITEM
		{
			get { return new BaseTable<Data.Tables.method_id_row>(this, TableType.METHOD_ID_ITEM); }
		}

		/// <summary>Class structure list</summary>
		public BaseTable<Data.Tables.class_data_row> CLASS_DATA_ITEM
		{
			get { return new BaseTable<Data.Tables.class_data_row>(this, TableType.CLASS_DATA_ITEM); }
		}

		/// <summary>Static and instance fields from the class_data_item</summary>
		public BaseTable<Data.Tables.encoded_field_row> encoded_field
		{
			get { return new BaseTable<Data.Tables.encoded_field_row>(this, TableType.encoded_field); }
		}

		/// <summary>Class method definition list</summary>
		public BaseTable<Data.Tables.encoded_method_row> encoded_method
		{
			get { return new BaseTable<Data.Tables.encoded_method_row>(this, TableType.encoded_method); }
		}
		...
		/// </remarks>
		public BaseTable<Data.Tables.class_def_row> CLASS_DEF_ITEM
		{
			get { return new BaseTable<Data.Tables.class_def_row>(this, TableType.CLASS_DEF_ITEM); }
		}

		/// <summary>Where in the code exceptions are caught and how to handle them.</summary>
		public BaseTable<Data.Tables.try_item_row> try_item
		{
			get { return new BaseTable<Data.Tables.try_item_row>(this, TableType.try_item); }
		}

		/// <summary>Catch handler lists</summary>
		public BaseTable<Data.Tables.encoded_catch_handler_row> encoded_catch_handler_list
		{
			get { return new BaseTable<Data.Tables.encoded_catch_handler_row>(this, TableType.encoded_catch_handler_list); }
		}

		/// <summary>One for each caught type, in the order that the types should be tested.</summary>
		public BaseTable<Data.Tables.encoded_type_addr_pair_row> encoded_type_addr_pair
		{
			get { return new BaseTable<Data.Tables.encoded_type_addr_pair_row>(this, TableType.encoded_type_addr_pair); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.annotation_directory_row> ANNOTATIONS_DIRECTORY_ITEM
		{
			get { return new BaseTable<Data.Tables.annotation_directory_row>(this, TableType.ANNOTATIONS_DIRECTORY_ITEM); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.field_annotation_row> field_annotation
		{
			get { return new BaseTable<Data.Tables.field_annotation_row>(this, TableType.field_annotation); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.method_annotation_row> method_annotation
		{
			get { return new BaseTable<Data.Tables.method_annotation_row>(this, TableType.method_annotation); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.parameter_annotation_row> parameter_annotation
		{
			get { return new BaseTable<Data.Tables.parameter_annotation_row>(this, TableType.parameter_annotation); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.annotation_set_ref_row> ANNOTATION_SET_REF_LIST
		{
			get { return new BaseTable<Data.Tables.annotation_set_ref_row>(this, TableType.ANNOTATION_SET_REF_LIST); }
		}

		/// <summary>banana banana banana</summary>
		public BaseTable<Data.Tables.annotation_set_row> ANNOTATION_SET_ITEM
		{
			get { return new BaseTable<Data.Tables.annotation_set_row>(this, TableType.ANNOTATION_SET_ITEM); }
		}
		...
		public DexFile(IImageLoader loader)
		{
			...
			this._header = this.PtrToStructure<Dex.header_item>(0);
			if(!this._header.IsValid)
				throw new InvalidOperationException("Invalid DEX header");

			switch(this.header.endian_tag)
			{
			case Dex.ENDIAN.ENDIAN:
				this._loader.Endianness = EndianHelper.Endian.Little;
				break;
			case Dex.ENDIAN.REVERSE_ENDIAN:
				this._loader.Endianness = EndianHelper.Endian.Big;
				this._header = this.PtrToStructure<Dex.header_item>(0);//TODO: Check it
				break;
			}
		}
		...
		public Dex.map_item? GetMapItem(Dex.TYPE type)
		{
			foreach(Dex.map_item item in this.map_list)
				if(item.type == type)
					return item;
		...
		public IEnumerable<Table> GetSectionTables()
		{
			foreach(TableType type in Enum.GetValues(typeof(TableType)))
				yield return this.GetSectionTable(type);
		}
		...
		public Table ReadSectionTable(TableType type)
		{
			...
			case TableType.STRING_DATA_ITEM:
				Dex.map_item mapItem1 = this.GetMapItem((Dex.TYPE)type).Value;
				result = new TableString();
				result.ReadSection(this, mapItem1.offset, mapItem1.size);
				break;
			case TableType.CODE_ITEM:
				Dex.map_item mapItem2 = this.GetMapItem((Dex.TYPE)type).Value;
				result = new TableCode();
				result.ReadSection(this, mapItem2.offset, mapItem2.size);
				break;
			case TableType.CLASS_DATA_ITEM:
				Dex.map_item mapItem3 = this.GetMapItem((Dex.TYPE)type).Value;
				result = new TableClass();
				result.ReadSection(this, mapItem3.offset, mapItem3.size);
				break;
			case TableType.ANNOTATIONS_DIRECTORY_ITEM:
				Dex.map_item mapItem4 = this.GetMapItem((Dex.TYPE)type).Value;
				result = new TableAnnotationDirectory();
				result.ReadSection(this, mapItem4.offset, mapItem4.size);
				break;
			default:
				Dex.map_item mapItem5 = this.GetMapItem((Dex.TYPE)type).Value;
				result = new Table(type);
				result.ReadSection(this, mapItem5.offset, mapItem5.size);
				break;
			}
		...
		private Dex.map_item[] ReadMapList()
		{
			if(!this.header.IsValid)
				throw new InvalidOperationException("Invalid header");

			UInt32 sizeOfStruct = (UInt32)Marshal.SizeOf(typeof(Dex.map_item));

			UInt32 offset = this.header.map_off;
			UInt32 size = this.PtrToStructure<UInt32>(this.header.map_off);
			offset += sizeof(UInt32);

			Dex.map_item[] result = new Dex.map_item[size];
			for(UInt32 loop = 0; loop < size; loop++)
			{
				result[loop] = this.PtrToStructure<Dex.map_item>(offset);
				offset += sizeOfStruct;
			}
