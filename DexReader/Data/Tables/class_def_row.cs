...
namespace AlphaOmega.Debug.Data.Tables
{
	...
	/// </remarks>
	[DebuggerDisplay("{access_flags} {class_idx.descriptor_idx.data} (Source: {source_file_idx})")]
	public class class_def_row : BaseRow
	{
		private UInt32 class_idxI { get { return base.GetValue<UInt32>(0); } }
		...
		public Dex.ACC access_flags { get { return base.GetValue<Dex.ACC>(1); } }

		private UInt32 superclass_idxI { get { return base.GetValue<UInt32>(2); } }

		/// <summary>
		/// Index into the type_ids list for the superclass, or the constant value <see cref="Dex.NO_INDEX"/> if this class has no superclass (i.e., it is a root class such as Object).
		...
		public type_id_row superclass_idx
		{
			get
			{
				return this.superclass_idxI == Dex.NO_INDEX
					? null
					: base.File.TYPE_ID_ITEM[this.superclass_idxI];
			}
		}

		private UInt32 interfaces_offI { get { return base.GetValue<UInt32>(3); } }
		...
		public type_list_row interfaces_off
		{
			get
			{
				return this.interfaces_offI == 0
					? null
					: base.File.TYPE_LIST.GetRowByOffset(this.interfaces_offI);
			}
		}

		private UInt32 source_file_idxI { get { return base.GetValue<UInt32>(4); } }

		/// <summary>
		/// Index into the string_ids list for the name of the file containing the original source for (at least most of) this class, or the special value <see cref="Dex.NO_INDEX"/> to represent a lack of this information.
		...
		public string_data_row source_file_idx
		{
			get
			{
				return this.source_file_idxI == Dex.NO_INDEX
					? null
		...
		/// </summary>
		public UInt32 annotations_off { get { return base.GetValue<UInt32>(5); } }

		private UInt32 class_data_offI { get { return base.GetValue<UInt32>(6); } }
		...
		/// </summary>
		public UInt32 static_values_off { get { return base.GetValue<UInt32>(7); } }
	}
}