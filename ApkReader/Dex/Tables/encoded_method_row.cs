...
namespace AlphaOmega.Debug.Dex.Tables
{
	...
	public class encoded_method_row : BaseRow
	{
		...
		public UInt32 method_idx_diff => (UInt32)base.GetValue<Int32>(0);

		/// <summary>Access flags for the method (public, final, etc.).</summary>
		public DexApi.ACC access_flags => (DexApi.ACC)base.GetValue<Int32>(1);

		private UInt32 code_offI => (UInt32)base.GetValue<Int32>(2);
