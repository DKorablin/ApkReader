...
namespace AlphaOmega.Debug.Dex.Tables
{
	...
	{
		private UInt32 descriptor_idxI => base.GetValue<UInt32>(0);
		...
		/// </summary>
		public string_data_row descriptor_idx => base.File.STRING_DATA_ITEM[this.descriptor_idxI];
