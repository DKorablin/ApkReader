...
namespace AlphaOmega.Debug.Dex.Tables
{
	...
	public class class_def_row : BaseRow
	{
		...
		public DexApi.ACC access_flags { get { return base.GetValue<DexApi.ACC>(1); } }
		...
		public type_id_row superclass_idx
		{
			get
			{
				return this.superclass_idxI == DexApi.NO_INDEX
					? null
		...
		public string_data_row source_file_idx
		{
			get
			{
				return this.source_file_idxI == DexApi.NO_INDEX
					? null
