...
namespace AlphaOmega.Debug.Dex.Tables
{
	...
	{
		private UInt32 shorty_idxI { get { return base.GetValue<UInt32>(0); } }

		private UInt32 return_type_idxI { get { return base.GetValue<UInt32>(1); } }
		...
		/// </summary>
		public string_data_row shorty_idx { get { return base.File.STRING_DATA_ITEM[this.shorty_idxI]; } }

		/// <summary>Index into the type_ids list for the return type of this prototype.</summary>
		public type_id_row return_type_idx { get { return base.File.TYPE_ID_ITEM[this.return_type_idxI]; } }

		private UInt32 parameters_offI { get { return base.GetValue<UInt32>(2); } }
