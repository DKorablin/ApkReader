...
namespace AlphaOmega.Debug.Manifest
{
	...
	public class ApkData : ApkNodeT<ApkIntentFilter>
	{
		...
		public String Scheme => this.GetAttributeValue("scheme");
		...
		/// </remarks>
		public String Host => this.GetAttributeValue("host");
		...
		public String Port => this.GetAttributeValue("port");
		...
		public String Path => this.GetAttributeValue("path");
		...
		/// </summary>
		public String PathPattern => this.GetAttributeValue("pathPattern");
		...
		public String PathPrefix => this.GetAttributeValue("pathPrefix");
		...
		public String MimeType => this.GetAttributeValue("mimeType");
